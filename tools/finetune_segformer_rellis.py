"""
finetune_segformer_rellis.py

Fine-tunes our AVMI-trained SegFormer-B2 (80.51% mIoU) on RELLIS only
with 6-class mapping:  sky | tree | bush | ground | obstacle | rock

Starts from:  work_dirs/segformer_b2_avmi_hf/latest.pth
Saves to:     work_dirs/segformer_b2_finetune_rellis/

Run on Turing HPC via train_finetune_rellis.sh
"""
...
WORK_DIR     = os.path.join(_REPO_ROOT, 'work_dirs', 'segformer_b2_finetune_rellis')
